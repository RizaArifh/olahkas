...
<h2>Per : <?php if($num==0){echo 'Data Masih Kosong';}else{echo DateTime::createFromFormat('Y-m-d', $st)->format('d M Y');}?></h2> 
    <?php $i = 1; ?>
  ...
  <div class="col-2">
    <select name="no_petty" id="petty" class="form-control" onChange="updatedata(this.value)" required>
            ...
            <div class="col-3"></div></div><div class="row">
...
<?php
          ...
          <tfoot>
            <tr class="bg-info" style="color:white" >
              ...
              <th colspan="2" style="text-align:left;padding-left:1.75%;"><?php if($num>0){echo rupiah($sis);}else{echo 'RP 25.000.000,00';} ?></th>
