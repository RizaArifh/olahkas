        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="col-lg-6" style="margin-left:-2%">
                    <div class="col-lg-5">
                        <a href="../back/clear_petty_tertentu.php?ids=<?= $idsk ?>" class="btn btn-danger" onclick="return confirm('Hapus Semua Petty Sesi <?=$idsk?>');">Clear Kegiatan Petty Ke <?= $idsk ?></a>
                    </div>
                    <div class="col-lg-4">
                            ...
                            if ($num > 0) { // user ditemukan
                                ...
                                foreach ($datap as $row) { ?>
                                    <tr>
                                        ...
                                        <td class="col-lg-1"><a href="../back/delete_kegiatan_petty_lap.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Hapus Petty ini?');">hapus</a></td>
                                    </tr>
                                    <?php $i++; ?>
